    ...
    articles = [
        {
            ...
            "description": "Find out the in depth batting and bowling figures for Mumbai Indians v Delhi Capitals in the Indian Premier League on BBC Sport.",
    ...
    render() {
        ...
        return (
            <div className="container my-6">
                ...
                <NewsItem title="This is my title" description="This is my description" imageUrl="https:////m.files.bbci.co.uk/modules/bbc-morph-sport-seo-meta/1.21.1/images/bbc-sport-logo.png"/>
                    </div>
                    <div className="col-md-4">
                <NewsItem title="This is my title" description="This is my description"/>
                    </div>
                    <div className="col-md-4">
                <NewsItem title="This is my title" description="This is my description"/>
                    </div>
